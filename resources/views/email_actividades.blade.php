...
<html>
  <head>
    ...
    <title>SIA - Correo electrónico transaccional simple</title>
    <style>
      /* -------------------------------------
          GLOBAL RESETS
      ------------------------------------- */
      ...
      <tr>
        ...
        <td class="container">
          <div class="content">
            ...
            <span class="preheader">Sistema de Información y Autoevaluación.</span>
                            ...
                            <tr>
                              <td align="left">
                                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                  <tbody>
                                    <tr>
                                      <td> <a href="http://localhost:8000/login" target="_blank">Ingresar al sistema</a> </td>
                                    </tr>
                                  </tbody>
                                </table>
                              </td>
