...
@push('functions')
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            table = $('#institucion_table_ajax').DataTable({
                ...
                "columns": [
                    ...
                    {
                        defaultContent:
                            '@can('ELIMINAR_INSTITUCIONES')<a href="javascript:;" class="btn btn-simple btn-danger btn-sm remove" data-toggle="confirmation"><i class="fa fa-trash"></i></a>@endcan' +
                            '@can('MODIFICAR_INSTITUCIONES')<a href="javascript:;" class="btn btn-simple btn-info btn-sm edit" data-toggle="confirmation"><i class="fa fa-pencil"></i></a>@endcan',
                        data: 'action',
                        name: 'action',
                        title: 'Acciones',
                        orderable: false,
        ...
        function SwalDelete(id, route) {
            swal({
            title: 'Esta seguro?',
            text: "La institución será eliminada permanentemente!",
            type: 'warning',
