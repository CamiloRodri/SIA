...
@section('content')
    @component('admin.components.panel')
        @slot('title', 'Crear Lineamiento')
        {!! Form::open([
            'route' => 'admin.lineamientos.store',
            'method' => 'POST',
            'files' => true,
            'id' => 'form_crear_lineamiento',
            'class' => 'form-horizontal form-label-left'

        ])!!}
        @include('autoevaluacion.SuperAdministrador.Lineamientos._form')
        <div class="form-group">
            {!! Form::label('archivo','Importar lineamientos desde excel', ['class'=>'control-label col-md-3 col-sm-3 col-xs-12']) !!}
        ...
        <div class="form-group">
            <div class="col-md-6 col-md-offset-3">
                ...
                {!! Form::submit('Crear Lineamiento', ['class' => 'btn btn-success', 'id'=>'crearLineamiento']) !!}
            </div>
        </div>
        {!! Form::close() !!}
    @endcomponent
...
@push('functions')
    <script type="text/javascript">
        Dropzone.options.myDropzone = {
            url: $('#form_crear_lineamiento').attr('action'),
        ...
        $(document).ready(function () {
            var form = $('#form_crear_lineamiento');
            $(form).parsley({
                trigger: 'change',
