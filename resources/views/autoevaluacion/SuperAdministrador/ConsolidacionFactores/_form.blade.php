...
<div class="item form-group">
    ...
    <div class="col-md-8 col-sm-6 col-xs-12">
        {!! Form::select('PK_FCT_Id', $factores, old('PK_FCT_Id', isset($indicador)? $indicador->caracteristica->factor()->pluck('PK_FCT_Id',
...
<div class="item form-group">
    ...
    <div class="col-md-8 col-sm-6 col-xs-12">
        ...
        isset($indicador)? $indicador->FK_CNS_Caracteristica: ''),
