...
@section('content')
    @component('admin.components.panel')
        @slot('title', 'Modificar Factor')
        {!! Form::model($user, [
            'route' => ['admin.factores.update', $user],
            'method' => 'PUT',
            'id' => 'form_modificar_factor',
        ...
        <div class="form-group">
            <div class="col-md-6 col-md-offset-3">
                ...
                {!! Form::submit('Modificar Factor', ['class' => 'btn btn-success']) !!}
            </div>
        </div>
        {!! Form::close() !!}
    @endcomponent
...
@push('functions')
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var form = $('#form_modificar_factor');
            $(form).parsley({
                trigger: 'change',
