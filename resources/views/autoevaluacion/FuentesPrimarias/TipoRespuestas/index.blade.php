...
@can('CREAR_TIPO_RESPUESTAS')
    <div class="col-md-12">
        <div class="actions">
            <a href="{{ route('fuentesP.tipoRespuesta.create') }}" class="btn btn-info">
                <i class="fa fa-plus"></i> Agregar Tipo de Respuestas</a></div>
    </div>
    <br>
    <br>
    <br>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            table.on('click', '.edit', function (e) {
                ...
                $tr = $(this).closest('tr');
                var dataTable = table.row($tr).data();
                var route = '{{ url('admin/fuentesPrimarias/tipoRespuesta/') }}' + '/' + dataTable.PK_TRP_Id + '/edit';
                ...
                preConfirm: function () {
                    return new Promise(function (resolve) {
                        $.ajax({
                            ...
                            .fail(function () {
                                swal('Error', 'Existe una pregunta que hace parte de una encuesta en uso para un proceso que se encuentra en fase de captura de datos!', 'error');
                            });
                    });
                },
