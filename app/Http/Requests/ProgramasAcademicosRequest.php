...
class ProgramasAcademicosRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'PAC_Numero_Creditos.max' => 'Campo debe ser numérico.',
            ...
            'PAC_Nucleo.required' => 'Campo Número básico del conocimiento requerdio',
            'PAC_Nucleo.max' => 'Campo Nucleo debe terner máximo 30 caracteres',
